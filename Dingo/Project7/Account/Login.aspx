          ...
          <div class="card-body p-5 shadow-5 text-center">
            <h2 class="fw-bold ">Sign in now</h2>
              ...
              <div class="form-check  mb-3">
                  ...
                  <asp:Label runat="server" AssociatedControlID="RememberMe">Remember me?</asp:Label><br /><asp:HyperLink runat="server" ID="RegisterHyperLink" ViewStateMode="Disabled">Register with us</asp:HyperLink>
