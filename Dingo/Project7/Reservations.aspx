...
<asp:TextBox ID="TextBox1" autopostback="true" runat="server" class="form-control bg-white border-2" placeholder="Search by Reservation id or User Name" OnTextChanged="TextBox1_TextChanged"></asp:TextBox>
              </div>
